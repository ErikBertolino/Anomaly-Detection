...
def main(modelpath, folderpath):
    ...
    #Training
    solver.training(modelpath, folderpath, neuralnet=neuralnet, dataset=dataset, epochs=FLAGS.epoch, batch_size=FLAGS.batch, size=FLAGS.Outlier_size, Lgrad_weight=FLAGS.Lgrad_weight, \
